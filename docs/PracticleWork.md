# Practical Exercises
There are particular approaches that an experienced network engineer will take when they are doing configurations, for a medium or large customer. I have some goals when I do this kind of work:
...
```
To configure a range of ports, I can just change the first line to 
```
int range gi0/1-24
```
...
2. If I must configure twenty switches in a consistent manner, I paste 20 times!
...
5. I have records of what I have done and a good script might last a few years and be usable on multiple projects before it needs updating.
